          ...
          <FadeIn delay={200}>
            <div className="relative z-10 bg-[#0a0f1c] border border-white/10 p-8 rounded-lg shadow-2xl max-w-md mx-auto">
              ...
              <div className="space-y-6">
                {[
                  { city: "New Delhi", time: times.delhi, active: true },
                  { city: "Dubai", time: times.dubai, active: false },
                  { city: "London", time: times.london, active: false },
                  { city: "New York", time: times.newyork, active: false },
                ].map((zone, i) => (
                  <div key={i} className={`flex items-center justify-between ${zone.active ? 'opacity-100' : 'opacity-50'}`}>
                    ...
                    <span className="text-[#c5a059] font-mono w-20 text-right">{zone.time || "..."}</span>
                  </div>
                ))}
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">office.irshad.hanif@gmail.com</p>
              </div>
            </div>
          </div>
...
const App = () => {
  ...
  React.useEffect(() => {
    // sessionStorage keeps it hidden during reloads, but shows it again if the tab is closed and reopened
    if (!sessionStorage.getItem('hasSeenDisclaimer')) {
  ...
  return (
    <div className="bg-[#0a0f1c] min-h-screen text-white font-sans selection:bg-[#c5a059] selection:text-white overflow-x-hidden">
      ...
      <main>
        ...
        <GlobalDesk />
        <Contact />
      {/* Disclaimer Modal - Full Page Bar Council Requirements */}
      {showDisclaimer && (
        <div className="fixed inset-0 bg-[#05080f]/95 backdrop-blur-md z-[100] flex items-center justify-center p-6 md:p-10 overflow-y-auto">
          <div className="bg-[#0a0f1c] border border-white/10 shadow-2xl max-w-4xl w-full p-8 md:p-12 relative my-auto">
            <div className="flex flex-col items-center mb-8 border-b border-white/10 pb-6">
              <Scale className="text-[#c5a059] mb-4" size={40} />
              <h2 className="text-3xl font-serif text-white tracking-wide">Disclaimer</h2>
            </div>
            
            <div className="text-gray-400 text-sm md:text-base leading-relaxed space-y-4 max-h-[50vh] overflow-y-auto pr-4 custom-scrollbar">
              <p className="font-bold text-gray-200">
                The Bar Council of India prohibits the developing of the website for the advertisement by an Advocate.
              </p>
              <p>By clicking "I Agree" below, the user acknowledges the following:</p>
              <p>
              ...
              <p>
                If you wish to get more information about us or would like to get in touch with <strong className="text-gray-300">Advocate Mohd. Irshad Hanif</strong>, you may contact us on our registered email address: <strong className="text-[#c5a059]">office.irshad.hanif@gmail.com</strong>.
              </p>
              <p>
            ...
            <div className="mt-8 pt-6 flex flex-col items-center">
              <p className="text-xs text-gray-500 uppercase tracking-widest mb-6">Note: Access will only be granted once you confirm you have read and agree to the above.</p>
              <button 
                onClick={closeDisclaimer}
                className="px-12 py-4 bg-[#c5a059] text-[#0a0f1c] font-bold uppercase tracking-widest hover:bg-white transition-all duration-300"
              >
                I Agree
              </button>
            </div>
